...
public class Vector {
	 ...
	 */
	public Vector additionne(Vector v){	
	 ...
	 * @return La somme des deux vecteurs
	 */
	public static Vector additionne(Vector v1, Vector v2)
	{ 
	 ...
	 */
	public Vector soustrait(Vector v){
		return new Vector(x - v.x, y - v.y);
	}
	 ...
	 */
	public static Vector soustrait(Vector v1, Vector v2)
	{ 
	 ...
	 */
	public Vector multiplie(double m){
	 ...
	 * @return Le resultat de la multiplication par un scalaire m sur le vecteur.
	 */
	public static Vector multiplie(Vector v, double m)
	{ 
	 ...
	 */
	public Vector normalise() throws Exception
	{
	 ...
	 * @throws Exception Si le vecteur ne peut pas etre normalise etant trop petit ou de longueur nulle.
	 */
	public static Vector normalise(Vector v) throws Exception
	{
		return v.normalise();
	}
	 ...
	 */
	public double prodScalaire(Vector v){
		return (x*v.x + y*v.y);
	}
